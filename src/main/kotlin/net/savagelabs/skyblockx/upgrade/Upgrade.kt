...
object BorderUpgrade : Upgrade {
    override fun runUpgradeEffect(island: Island, level: Int) {
        ...
        island.islandSize = Config.instance.upgrades[UpgradeType.BORDER]?.upgradeInfoPerLevel?.get(level)?.parameter?.toIntOrNull() ?: run {
...
object HomeUpgrade : Upgrade {
    override fun runUpgradeEffect(island: Island, level: Int) {
        ...
        island.homeBoost += Config.instance.upgrades[UpgradeType.MAX_HOMES]?.upgradeInfoPerLevel?.get(level)?.parameter?.toIntOrNull() ?: run {
...
object TeamUpgrade : Upgrade {
    override fun runUpgradeEffect(island: Island, level: Int) {
        ...
        island.memberBoost += Config.instance.upgrades[UpgradeType.TEAM_SIZE]?.upgradeInfoPerLevel?.get(level)?.parameter?.toIntOrNull() ?: run {
