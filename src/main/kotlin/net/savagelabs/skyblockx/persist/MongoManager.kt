...
//            playerCollection.findOneAndReplace(IPlayer::uuid eq uuid, iplayer)
            ...
            if (foundPlayer != null) playerCollection.updateOne(IPlayer::uuid eq uuid, iplayer) else playerCollection.insertOne(iplayer)
        }
...
//            islandCollection.findOneAndReplace(Island::islandID eq islandID, island)
            ...
            if (foundIsland != null) islandCollection.updateOne(Island::islandID eq islandID, island) else islandCollection.insertOne(island)
        }
